...
def save_similarity(data,output_folder):
    ...
    for problem_folder in data:
        ground_truth_path=os.path.join(r'D:\kod\term pro\pan19-cross-domain-authorship-attribution-training-dataset-2019-01-23',problem_folder,"ground-truth.json")
        with open(ground_truth_path, 'r', encoding='utf-8') as f:
            ground_truth=json.load(f)
        counter = 0
        for unknown in data[problem_folder]['unknown']:
            candidate_scores = []
...
if __name__ == "__main__":
    base_folder=r"D:\kod\term pro\tfidf_features_test"
    output_folder = r"D:\kod\term pro\cosine_similarities"
